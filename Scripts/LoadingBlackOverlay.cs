...
namespace PartyCritical
{
	...
	public class LoadingBlackOverlay : MonoBehaviour {
		private bool fading;
		...
		private void Awake()
		{
			LoadingBlackOverlay.ReverseNormals(this.gameObject);
		}
		...
		public void FadeOut(){
			...
			this.material.color = new Color(0,0,0,1);
		...
		public void FadeIn(){
			...
			this.material.color = new Color(0, 0, 0, 0);
